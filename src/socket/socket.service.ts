...
import { FriendInvitation, FriendInvitationDocument } from "src/friend/schema/friend.invitation.schema";
...
export class SocketService {
    ...
    updateFriendsPendingInvitations(userId: string): void {
        try {
            const pendingInvitations = this.friendService.getPendingInvitations(userId);
